      ...
      <div className="w-full h-[263px] flex flex-col justify-start items-start gap-12">
        ...
        <div className="w-full flex justify-center items-end gap-10">
          <div className="grow shrink basis-0 flex flex-col justify-center items-start gap-8">
            <div className="flex flex-col justify-start items-start gap-2">
              <h2 className="w-full text-[#303030] text-4xl font-bold font-['Geist'] leading-[43.20px]">
                Get early access to Pacto
              </h2>
              <p className="w-full text-[#8b8b8b] text-base font-normal font-['Geist'] leading-tight">
        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex justify-start items-center gap-16">
            ...
            <span className="text-center text-[#616161] text-xs font-semibold font-['Geist'] underline leading-[14.40px]">
              © 2024
            </span>
          </div>
        </div>
